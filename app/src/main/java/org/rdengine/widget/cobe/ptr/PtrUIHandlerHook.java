...
/**
 * Run a hook runnable, the runnable will run only once. After the runnable is done, call resume to resume. Once run, call takeover will directory call the resume action
 */
