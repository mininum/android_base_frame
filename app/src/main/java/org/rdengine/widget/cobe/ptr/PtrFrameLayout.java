...
import org.rdengine.widget.cobe.ptr.util.PtrCLog;

/**
 * This layout view for "Pull to Refresh(Ptr)" support all of the view, you can contain everything you want. support: pull to refresh / release to refresh / auto refresh / keep header_pad view while refreshing / hide header_pad view while refreshing It defines , which allows you customize the UI easily.
 */
public class PtrFrameLayout extends ViewGroup
{
    ...
    // optional config for define header_pad and content in xml file
    ...
    protected void onFinishInflate()
    {
        ...
        } else if (childCount == 2)
        {
            ...
            // not specify header_pad or content
    ...
    private void layoutChildren()
    {
        ...
        if (mHeaderView != null)
        {
            ...
            if (DEBUG && DEBUG_LAYOUT)
            {
                PtrCLog.d(LOG_TAG, "onLayout header_pad: %s %s %s %s", left, top, right, bottom);
            }
        }
        if (mContent != null)
        {
    ...
    {
        if (!isEnabled() || !mPullToRefreshEnable || mContent == null || mHeaderView == null)
        {
        ...
        case MotionEvent.ACTION_MOVE :
            ...
            // disable move when header_pad not reach top
    ...
    private void updatePos(int change)
    {
        ...
        if (mStatus == PTR_STATUS_PREPARE)
        {
            ...
            // reach header_pad height while auto refresh
    ...
    private void onRelease(boolean stayForLoading)
    {
        ...
        {
            // keep header_pad for fresh
            if (mKeepHeaderWhenRefresh)
            {
                // scroll header_pad back
