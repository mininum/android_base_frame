...
/**
 * 可以折叠的文本<br>
 * https://github.com/Carbs0126/ExpandableTextView<br>
 * 普通视图中的更新 etv.setText(text); <br>
 * 在ListView/RecyclerView中的应用 etv.updateForRecyclerView(text, etvWidth, state);//etvWidth为控件的真实宽度，state是控件所处的状态，“收缩”/“伸展”状态
 */
public class ExpandableTextView extends TextView
{
     ...
     *            the width of ExpandableTextView in px unit, used to get max line number of original text by given the width
     * @param expandState
     *            expand or shrink
     */
    ...
    /**
     * Copy from: http://stackoverflow.com/questions /20856105/change-the-text-color-of-a-single-clickablespan-when-pressed-without-affecting-o By: Steven Meliopoulos
     */
