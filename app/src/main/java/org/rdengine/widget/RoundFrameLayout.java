 ...
 * diy:horn_vertex_offsize="0.2"<br>
 * </ul>
 * 
 * @author CCCMAX
 */
public class RoundFrameLayout extends FrameLayout
{
    ...
    // 圆角
    private float[] radii =
    { Radius_topLeft, Radius_topLeft, Radius_topRight, Radius_topRight, Radius_bottomRight, Radius_bottomRight,
    ...
    // 尖角顶点 偏移 0～1 ， 0.5是中间
    private float horn_vertex_offsize = 0.5F;
    ...
    public void init(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        if (attrs != null)
        {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundFrameLayout, defStyle, 0);
            if (a != null)
            {
                int radius = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_corner_radius_all, -1);
                if (radius >= 0)
                {
                    setRoundedCornerRadius(radius);
                } else
                {
                    Radius_topLeft = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_corner_radius_topleft, 0);
                    Radius_topRight = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_corner_radius_topright, 0);
                    Radius_bottomRight = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_corner_radius_bottomright,
                            0);
                    Radius_bottomLeft = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_corner_radius_bottomleft,
                            0);
                    setRoundedCornerRadius(Radius_topLeft, Radius_topRight, Radius_bottomLeft, Radius_bottomRight);
                }

                stroke_width = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_layout_stroke_width, 0);
                stroke_color = a.getColor(R.styleable.RoundFrameLayout_layout_stroke_color, 0);

                // 尖角的方向
                String horn_direction_str = a.getString(R.styleable.RoundFrameLayout_horn_direction);
                ...
                // 尖角位置
                horn_position_offsize.left = a
                        .getDimensionPixelSize(R.styleable.RoundFrameLayout_horn_position_offsize_left, 0);
                horn_position_offsize.top = a
                        .getDimensionPixelSize(R.styleable.RoundFrameLayout_horn_position_offsize_top, 0);
                horn_position_offsize.right = a
                        .getDimensionPixelSize(R.styleable.RoundFrameLayout_horn_position_offsize_right, 0);
                horn_position_offsize.bottom = a
                        .getDimensionPixelSize(R.styleable.RoundFrameLayout_horn_position_offsize_bottom, 0);
                // 尖角 宽高
                horn_w = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_horn_width, 0);
                horn_h = a.getDimensionPixelSize(R.styleable.RoundFrameLayout_horn_height, 0);
                horn_vertex_offsize = a.getFloat(R.styleable.RoundFrameLayout_horn_vertex_offsize, 0.5F);
    ...
    public void draw(Canvas canvas)
    {
        ...
        canvas.saveLayerAlpha(fullrect, 0xFF);
        ...
        if (horn_w > 0 && horn_h > 0)
        {
            ...
            case Gravity.LEFT :
            {
                ...
                horn_path.moveTo(horn_rect.left,
                        horn_rect.top + (horn_rect.bottom - horn_rect.top) * horn_vertex_offsize);// c1顶点
            ...
            case Gravity.TOP :
            {
                ...
                horn_path.moveTo(horn_rect.left + (horn_rect.right - horn_rect.left) * horn_vertex_offsize,
                        horn_rect.top);// c1顶点
            ...
            case Gravity.RIGHT :
            {
                ...
                horn_path.moveTo(horn_rect.right,
                        horn_rect.top + (horn_rect.bottom - horn_rect.top) * horn_vertex_offsize);// c1顶点
