...
public class CalligraphyConfig
{
    ...
    /**
     * The default styles for the factory to lookup. The builder builds an extended immutable map of this with any additional custom styles.
     */
     ...
     * 
     * @param calligraphyConfig
     *            the config build using the builder.
     * @see Builder
     */
    ...
    /**
     * The current Calligraphy Config. If not set it will create a default config.
     */
    ...
    protected CalligraphyConfig(Builder builder)
    {
        ...
        final Map<Class<? extends TextView>, Integer> tempMap = new HashMap<Class<? extends TextView>, Integer>(
                DEFAULT_STYLES);
    ...
    public static class Builder
    {
         ...
         * 
         * @param fontAssetAttrId
         *            the custom attribute to look for fonts in assets.
         * @return this builder.
         */
         ...
         * 
         * @param defaultFontAssetPath
         *            a path to a font file in the assets folder, e.g. "fonts/Roboto-light.ttf", passing null will default to the device font-family.
         * @return this builder.
         */
        ...
        /**
         * <p>
         * Turn of the use of Reflection to inject the private factory. This has operational consequences! Please read and understand before disabling. <b>This is already disabled on pre Honeycomb devices. (API 11)</b>
         * </p>
         * <p>
        ...
        /**
         * Due to the poor inflation order where custom views are created and never returned inside an {@code onCreateView(...)} method. We have to create CustomView's at the latest point in the overrideable injection flow. On HoneyComb+ this is inside the {@link android.app.Activity#onCreateView(android.view.View, String, android.content.Context, android.util.AttributeSet)} Pre HoneyComb this is in the {@link android.view.LayoutInflater.Factory#onCreateView(String, android.util.AttributeSet)}
         * We wrap base implementations, so if you LayoutInflater/Factory/Activity creates the custom view before we get to this point, your view is used. (Such is the case with the TintEditText etc) The problem is, the native methods pass there parents context to the constructor in a really specific place. We have to mimic this in
         * {@link uk.co.chrisjenx.calligraphy.CalligraphyLayoutInflater#createCustomViewInternal(android.view.View, android.view.View, String, android.content.Context, android.util.AttributeSet)} To mimic this we have to use reflection as the Class constructor args are hidden to us. We have discussed other means of doing this but this is the only semi-clean way of doing it. (Without having to do proxy classes etc). Calling this will of course speed up inflation by turning off reflection, but not
         * by much, But if you want Calligraphy to inject the correct typeface then you will need to make sure your CustomView's are created before reaching the LayoutInflater onViewCreated.
         */
