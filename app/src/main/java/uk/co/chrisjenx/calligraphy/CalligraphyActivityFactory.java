...
/**
 * Created by chris on 09/11/14. For Calligraphy.
 */
interface CalligraphyActivityFactory
{

    /**
     * Used to Wrap the Activity onCreateView method. You implement this method like so in you base activity.
     * 
     * <pre>
     * {@code
     ...
     * 
     * @param parent
     *            parent view, can be null.
     * @param view
     *            result of {@code super.onCreateView(parent, name, context, attrs)}, this might be null, which is fine.
     * @param name
     *            Name of View we are trying to inflate
     * @param context
     *            current context (normally the Activity's)
     * @param attrs
     *            see {@link android.view.LayoutInflater.Factory2#onCreateView(View, String, Context, AttributeSet)} @return the result from the activities {@code onCreateView()}
