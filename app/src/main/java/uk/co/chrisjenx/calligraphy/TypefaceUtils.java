...
/**
 * A helper loading {@link Typeface} avoiding the leak of the font when loaded by multiple calls to {@link Typeface#createFromAsset(AssetManager, String)} on pre-ICS versions.
 * <p>
...
public final class TypefaceUtils
{
    ...
    public static Typeface load(final AssetManager assetManager, final String filePath)
    {
        synchronized (sCachedFonts)
        {
            ...
            {
                Log.w("Calligraphy", "Can't create asset from " + filePath
                        + ". Make sure you have passed in the correct path and file name.", e);
     ...
     * 
     * @param typeface
     *            nullable, the typeface to check if ours.
