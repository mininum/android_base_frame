...
public class CalligraphyContextWrapper extends ContextWrapper
{
    ...
    /**
     * Uses the default configuration from {@link CalligraphyConfig} Remember if you are defining default in the {@link CalligraphyConfig} make sure this is initialised before the activity is created.
     * 
     * @param base
     *            ContextBase to Wrap.
    ...
    /**
     * You only need to call this <b>IF</b> you call {@link CalligraphyConfig.Builder#disablePrivateFactoryInjection()} This will need to be called from the {@link Activity#onCreateView(View, String, Context, AttributeSet)} method to enable view font injection if the view is created inside the activity onCreateView. You would implement this method like so in you base activity.
     *
     * <pre>
     * {@code
     ...
     *
     * @param activity
     *            The activity the original that the ContextWrapper was attached too.
     * @param parent
     *            Parent view from onCreateView
     * @param view
     *            The View Created inside onCreateView or from super.onCreateView
     * @param name
     *            The View name from onCreateView
     * @param context
     *            The context from onCreateView
     * @param attr
     *            The AttributeSet from onCreateView
     * @return The same view passed in, or null if null passed in.
     */
    public static View onActivityCreateView(Activity activity, View parent, View view, String name, Context context,
            AttributeSet attr)
    {
    ...
    /**
     * Override the default AttributeId, this will always take the custom attribute defined here and ignore the one set in {@link CalligraphyConfig}. Remember if you are defining default in the {@link CalligraphyConfig} make sure this is initialised before the activity is created.
     *
     * @param base
     *            ContextBase to Wrap
     * @param attributeId
