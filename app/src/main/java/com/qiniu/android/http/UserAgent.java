...
public final class UserAgent
{
    ...
    {
        return format("QiniuAndroid/%s (%s; %s; %s)", Constants.VERSION, osVersion(), device(), id);
    }
    ...
    private static String deviceName(String manufacturer, String model)
    {
        ...
        if ((str.startsWith("unknown")) || (str.startsWith("alps")) || (str.startsWith("android"))
                || (str.startsWith("sprd")) || (str.startsWith("spreadtrum")) || (str.startsWith("rockchip"))
                || (str.startsWith("wondermedia")) || (str.startsWith("mtk")) || (str.startsWith("mt65"))
                || (str.startsWith("nvidia")) || (str.startsWith("brcm")) || (str.startsWith("marvell"))
